...
function extendConf (conf) {
  ...
  conf.boot.push('~quasar-app-extension-q-grouped-table/src/boot/register-my-component.js')
  ...
  conf.css.push('~quasar-app-extension-q-grouped-table/src/component/QGroupedTable.styl')
}
